...
class Sonaar_Music_Public {
	...
	public function enqueue_styles() {
		...
		if ( function_exists( 'run_sonaar_music_pro' ) ){
			...
			$data .= ( Sonaar_Music::get_option('sticky_player_featured_color') !== '' )? '#sonaar-player .playlist button.play, #sonaar-player.list-type-podcast .playlist .tracklist .sonaar-callToAction, #sonaar-player.list-type-podcast .store .track-store li a, #sonaar-player .close.btn-player, #sonaar-player .ui-slider-handle, .ui-slider-range{background-color:' . Sonaar_Music::get_option('sticky_player_featured_color') . ';}' : '';
