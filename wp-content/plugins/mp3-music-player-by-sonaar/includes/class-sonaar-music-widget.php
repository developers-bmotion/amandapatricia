    ...
    public function widget ( $args, $instance ){
       ...
       if($show_playlist) {
        ...
        foreach( $playlist['tracks'] as $track){
            ...
            //var_dump("SONG STOREEEE = " . $track['song_store']);
            ...
            if ( $show_track_market && is_array($track['song_store_list']) ){
                if ($track['has_song_store']){
                    ...
                    foreach( $track['song_store_list'] as $store ){
                        ...
                        $song_store_list .= '<a href="' . $store['store-link'] . '"' . $download . ' class="song-store" target="_blank" title="' . $store['store-name'] . '"><i class="' . $store['store-icon'] . '"></i></a>';
                    }
